...
\begin{figure}
    ...
    \caption{A $3\times 3$ grid of spherical scatterers, in an incident plane wave of frequency $f = 500 Hz$. The plot shows the Total Absolute Pressure (Pa) field on the surface of the scatterers, as well as a slice of the field on the $z=0$ plane.}
\end{figure}
