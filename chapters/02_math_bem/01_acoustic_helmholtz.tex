...
To derive the Helmholtz equation, we consider a time-harmonic acoustic field, applying a standard separation of variables to the wave equation \cite{arfkenmathematicalmethodsphysicists2005}. We assume the pressure can be represented as a complex function oscillating with angular frequency $\omega$:
